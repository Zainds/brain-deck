  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="relative overflow-hidden pt-12 pb-8" /* pt 16 pb 8 */>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-8 tracking-tight leading-tight">
              Запоминайте <span className="text-blue-600">навсегда</span>
              <br />
              без лишних усилий
            </h1>

            <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              BrainDeck использует алгоритм интервального повторения SuperMemo2,
              чтобы помочь вам выучить любой материал в кратчайшие сроки.
            </p>
        ...
        {/* Features Grid */}
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6" /* py-24 */
        >
